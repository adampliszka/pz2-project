...
namespace project.Controllers
{
    public class RatingsController : Controller
    {
        ...
        [Authorize(Roles = "Administrator")]
        public async Task<IActionResult> Create([Bind("ID,date,rating_value")] Rating rating)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Administrator")]
        public async Task<IActionResult> Edit(int id, [Bind("ID,date,rating_value")] Rating rating)
        {
            if (id != rating.ID)
            {
                return NotFound();
