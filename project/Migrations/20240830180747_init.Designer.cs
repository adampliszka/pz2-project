...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("project.Models.Movie", b =>
                {
                    ...
                    b.Property<double?>("ratingMode")
                        .HasColumnType("float");

                    b.Property<string>("tagMode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("project.Models.MovieGenre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("project.Models.MovieUser", b =>
                {
                    b.Property<int>("ID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("project.Models.Rating", b =>
                {
                    ...
                    b.HasOne("project.Models.MovieUser", "user")
                        .WithMany("ratings")
                        .HasForeignKey("userID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
