        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    genreString = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    tagMode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ratingMode = table.Column<double>(type: "float", nullable: true),
                    avgRating = table.Column<double>(type: "float", nullable: true),
                    medianRating = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_MovieUsers_userID",
                        column: x => x.userID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    userID = table.Column<int>(type: "int", nullable: false),
                    date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    tag_value = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tags_MovieUsers_userID",
                        column: x => x.userID,
                        principalTable: "MovieUsers",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
